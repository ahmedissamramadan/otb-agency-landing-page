...
const i18n = {
  en: {
    ...
    meta_system: 'System',
    c3_system: 'Bespoke Royal Monochrome & Gold',
    c3_format: 'Cross-Platform Guidelines',

    c4_title: 'Executive Growth Advisory & Category Dominance',
    c4_desc: 'Guiding corporate leadership through high-stakes market expansion, distributor onboarding, pricing architecture, and nationwide category leadership.',
    meta_governance: 'Scope',
    c4_scope: 'Category Dominance · Board Advisory',
    c4_deliverables: 'Market Gap Analysis · Channel Roadmaps',
    c4_results: 'Rank #25 to #2 National Acceleration',
    c4_impact: 'Enterprise FMCG & Industry Leaders',

    c5_title: 'Digital Infrastructure & CoreLink Automation',
    c5_desc: 'Deploying custom digital operations pipelines, automated lead routing, conversion telemetry, and institutional CRM architectures that eliminate commercial leakage.',
    c5_system: 'CoreLink CRM & Telemetry Infrastructure',
    c5_deliverables: 'Custom CRM Pipeline · WhatsApp Automation',
    c5_results: '0% Lead Leakage · 24/7 Operations',
    c5_security: 'Enterprise Grade Data Privacy',
  ...
  ar: {
    ...
    c3_format: 'إرشادات شاملة لكافة المنصات',

    c4_title: 'الاستشارات التنفيذية والقيادة الاستراتيجية للنمو',
    c4_desc: 'توجيه الإدارة العليا عبر قرارات التوسع الكبرى، وهيكلة التسعير، وفتح شبكات التوزيع، وقيادة العلامة نحو الهيمنة المطلقة على قطاعها التجاري.',
    meta_governance: 'النطاق القيادي',
    c4_scope: 'الريادة القطاعية · استشارات مجلس الإدارة',
    c4_deliverables: 'تحليل الفجوات السوقية · خرائط التوزيع',
    c4_results: 'قفزة تاريخية من المركز #25 إلى #2',
    c4_impact: 'كبار مصنعي FMCG والشركات الرائدة',

    c5_title: 'البنية التحتية الرقمية وأتمتة CoreLink',
    c5_desc: 'بناء وتدشين خطوط العمليات الرقمية المؤتمتة، وتوجيه العملاء الفوري، وبنية CoreLink CRM المؤسسية لمنع هدر أي فرصة بيعية على مدار الساعة.',
    c5_system: 'بنية CoreLink CRM والتيليمتري التشغيلي',
    c5_deliverables: 'منظومة CRM مخصصة · أتمتة واتساب',
    c5_results: '0% هدر في العملاء · تشغيل ذكي 24/7',
    c5_security: 'خصوصية بيانات ومعايير أمان مؤسسية',
