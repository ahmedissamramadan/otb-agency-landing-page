...
(function(root, factory) {
  ...
  const SUPABASE_CONFIG = {
    URL: 'https://vwezjcfdwhoyomymczrp.supabase.co',
    KEY: 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InZ3ZXpqY2Zkd2hveW9teW1jenJwIiwicm9sZSI6ImFub24iLCJpYXQiOjE3ODY1Njg3NDgsImV4cCI6MjEwMjE0NDc0OH0.SDRk6WnpWmGYXWHUFRuFyFJGWAQfJ-XX-0_5TWhMnsk'
  };
  ...
  class OTBStorageAdapter {
    ...
    async getDiscoveryBriefs() {
      ...
      try {
        ...
        console.warn('[OTBAdapter] Supabase discovery fetch fallback:', err);
      }
